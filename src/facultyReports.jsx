...
const FacultyReps = () => {
  ...
  return (
    <div className="flex">
      ...
      <div
        className="w-screen min-h-screen pt-32 bg-gray-100 px-6 py-12 text-gray-800 font-poppins w-full"
            ...
            >
              <div className="flex-1">
                ...
                {submittedClarifications[report.id] && (
                  <p className="text-sm mt-2 text-yellow-800 italic">
                    Clarification submitted: {submittedClarifications[report.id]}
                  </p>
                )}
              </div>
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                ...
                {["flagged", "rejected"].includes(report.status) && (
                  <button
                    onClick={() => setClarificationModal(report.id)}
                    className="bg-blue-900 text-white py-2 px-4 rounded hover:bg-gray-700 text-sm"
                  >
        ...
        {selectedReport && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4">
            <div className="bg-white p-6 rounded-lg max-w-2xl w-full shadow-xl overflow-y-auto max-h-[90vh]">
              <div ref={reportRef}>
                <h2 className="text-2xl font-bold text-green-800 mb-4">{selectedReport.title}</h2>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4">
            <div className="bg-white p-6 rounded-lg max-w-lg w-full shadow-xl">
              ...
              <textarea
                ...
                placeholder="Explain why this report was flagged/rejected..."
              />
                ...
                <button
                  onClick={() => {
                    setSubmittedClarifications((prev) => ({
                      ...prev,
                      [clarificationModal]: clarificationText,
                    }));
