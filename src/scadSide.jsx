...
const SCADSidebar = ({sidebarWidth, isHovered, handleMouseEnter, handleMouseLeave }) => {
    const navigate = useNavigate();

  return (
    <div
      className="fixed right-0 h-full bg-gray-700 border-l border-gray-300 shadow-lg transition-all duration-300 z-20"
